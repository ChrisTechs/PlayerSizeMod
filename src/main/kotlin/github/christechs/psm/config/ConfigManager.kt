...
class ConfigManager {
    ...
    private var configDirectory = File("config/psm")
    private var configFile: File
    var config: PSMConfig? = null
    private var lastSaveTime = 0L

    private lateinit var processor: MoulConfigProcessor<PSMConfig>
    ...
    private fun tryReadConfig() {
        try {
            ...
            config = gson.fromJson(builder.toString(), PSMConfig::class.java)
        } catch (e: Exception) {
